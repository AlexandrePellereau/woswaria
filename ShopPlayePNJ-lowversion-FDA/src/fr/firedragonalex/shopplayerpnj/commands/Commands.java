...
//			break;
		case "givevillagershop":
			ItemStack item = new ItemStack(Material.MONSTER_EGG, 1, EntityType.VILLAGER.getTypeId());
			ItemMeta itemMeta = item.getItemMeta();
		...
		case "givevillagershopinfinitetrade":
			ItemStack item2 = new ItemStack(Material.MONSTER_EGG, 1, EntityType.VILLAGER.getTypeId());
		...
		case "givevillagershopkiller":
			ItemStack item3 = new ItemStack(Material.MONSTER_EGG, 1, EntityType.VILLAGER.getTypeId());
